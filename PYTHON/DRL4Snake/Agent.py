...
class AgentPPO:
    ...
    @staticmethod
    def get_reward_sum_raw(self, buf_len, buf_reward, buf_mask, buf_value, pre_r_sum) -> Tuple[torch.Tensor, torch.Tensor]:
    ...
    @staticmethod
    def get_reward_sum_gae(self, buf_len, buf_reward, buf_mask, buf_value, pre_r_sum) -> Tuple[torch.Tensor, torch.Tensor]:
